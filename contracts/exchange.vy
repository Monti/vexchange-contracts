...
# @notice Vexchange is not safe with tokens that have a supply greater than 10^30,
# @notice or where 10^12 * pool_a * pool_b would result in an overflow (greater than 2^256-1).
